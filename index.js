...
app.post("/fourth", function (req, res) {
    ...
    if (ans == "1")
        score++;
    res.render("main", { level: 4, userName: userName, score: score, numbers: [2, 4, 7, 3, 9, 2], formPost: "fifth", options: [{ option: 247492, value: 0 }, { option: 247392, value: 1 }, { option: 247385, value: 0 }, { option: 247393, value: 0 }] });
})
